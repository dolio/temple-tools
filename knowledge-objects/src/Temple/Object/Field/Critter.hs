...
instance Field CritterField where
  fieldName = \case
  ...
  isPadding = \case
    ...
    CritterPadInt643 -> True
    CritterPadInt644 -> True
    CritterPadInt645 -> True
    CritterPadInt64Arr2 -> True
    CritterPadInt64Arr3 -> True
    CritterPadInt64Arr4 -> True
    CritterPadInt64Arr5 -> True
    _ -> False
